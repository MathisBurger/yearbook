...
class CourseController extends AbstractController
{
     ...
     * @return Response
     */
    #[Route('/admin/courses/details/{id}', name: 'course_view', methods: ['GET'])]
    public function courseView(int $id): Response {
        ...
        return $this->render('admin/course/view.html.twig', [
            ...
            'actions' => [
                ['class' => 'btn-primary', 'label' => 'View', 'linkPath' => 'member_details'],
     ...
     * @return Response
     */
    #[Route('/admin/courses/new', name: 'courses_new_view', methods: ['GET'])]
     ...
     * @return Response
     */
    #[Route('/admin/courses/new', name: 'courses_new', methods: ['POST'])]
